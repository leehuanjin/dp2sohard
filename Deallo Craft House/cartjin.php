		...
		<div class="container">
			...
			?>
				<table class="table table-condensed">
					<thead>
						<tr class="cart_menu">
							<td colspan="2" class="image">Name</td>
					...
					<tbody>
						<tr>
							...
							<td class="cart_description"><?php echo $item["code"]; ?></td>
							<td class="cart_quantity"><?php echo $item["quantity"]; ?></td>
							<td class="cart_price"><?php echo "$".$item["price"]; ?></td>
							<td class="cart_delete"><a href="cart.php?action=remove&code=<?php echo $item["code"]; ?>" class="cart_quantity_delete"><i class="fa fa-times"></i></a></td>
							<td></td>
						</tr>
						<?php
						...
						<tr>
							...
							<td colspan="4" align=left><?php echo "$".$item_total; ?></td>
						</tr>
					</tbody>
				</table>
				<?php
