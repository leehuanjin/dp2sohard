...
<html lang="en">
    <head>
        ...
        <title>Home | Deallo Craft House</title>
                        ...
                        <div class="col-sm-8">
                            <div class="shop-menu pull-right">
                                <ul class="nav navbar-nav">
                                    ...
                                    {
                                        echo "<li><a href='index.php?logout='1''><i class='fa fa-lock'></i> Logout</a></li>";
                                    }
                        ...
                        <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <div class="col-sm-6">
                                        <h1><span>D</span>-EALLO CRAFT HOUSE</h1>
                                        <h2>Welcome to Deallo!</h2>
                                        <p>paragraph here </p>
